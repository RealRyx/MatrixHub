...
--[[
    Abacaxi Hub Source - Remake By Matrix 
...
local Data =
{
    ["embeds"] = {
        {
            ["title"] = "**Script Main V1**",  -- Thêm phần tiêu đề vào đây
...
local function NotificacaoNightMystic(titulo, mensagem)
    local success = pcall(function()
        ...
        local LogoID = "rbxassetid://136944287595348"
        local duration = 5
...
-- GỌI THỬ ĐỂ TEST:
-- ==========================================
NotificacaoNightMystic("Matrix Hub Notification 🔔", "Script comback and new update🔥")
task.wait(0.8)
NotificacaoNightMystic("Matrix Hub Thông Báo 🔔", "Script đã trở lại và cập nhật mới🔥")
...
QuestNeta = function()
	...
	local Library = loadstring(game:HttpGet("https://pastefy.app/EHYZwbNE/raw"))():MakeWindow({
    Title = "Matrix Hub | UI V1",
    SubTitle = "by Ryx and Binh An DZ",
    SaveFolder = "matrix.json"
})
-- Criar ScreenGui
...
local MinimizeButton = Window:AddMinimizeButton({
    Button = { 
        Image = "rbxassetid://136944287595348", -- Dùng ID ảnh bạn chọn
        BackgroundTransparency = 1,
        Name = "Ryx and Binh An DZ_On_Top_V5.2.0.0.0.0.1" -- Đặt tên đúng yêu cầu
    },
...
Status:AddDiscordInvite({
    Name = "Server Discord Matrix Hub | Community✅",
    Description = "Vào Discord để nhận thông báo nha!  <3",
    Logo = "rbxassetid://136944287595348",
    Invite = "https://discord.gg/443Ku7xSf3"
})
